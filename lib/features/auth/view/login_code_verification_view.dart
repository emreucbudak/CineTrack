...
class LoginCodeVerificationView extends StatefulWidget {
  const LoginCodeVerificationView({
    super.key,
    required this.email,
  ...
  @override
  State<LoginCodeVerificationView> createState() =>
      _LoginCodeVerificationViewState();
}

class _LoginCodeVerificationViewState extends State<LoginCodeVerificationView> {
  ...
  Future<void> _handleVerify() async {
    ...
    try {
      final TokenAuthResult result = await context.read<AuthService>()
          .verifyLoginCode(
  ...
  Widget _buildHeader() {
    return Column(
      ...
      children: [
        ...
        const Text(
          'Hesabınıza girişi tamamlamak için 6 haneli kodu girin.',
